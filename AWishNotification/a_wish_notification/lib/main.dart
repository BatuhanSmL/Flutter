import 'dart:convert';
import 'package:a_wish_notification/firebase_options.dart';
import 'package:a_wish_notification/service.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'your WISH is my COMMAND'),
    );
  }
}
